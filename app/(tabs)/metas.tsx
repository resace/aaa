...
import { Subject, WeeklyGoal } from '@/utils/storage';
import { useAppContext } from '@/contexts/AppContext';

export default function Metas() {
  const { subjects, weeklyGoals, addWeeklyGoal, deleteWeeklyGoal } = useAppContext();
    ...
    Alert.alert(
      ...
      [
        { text: 'Cancelar', style: 'cancel' },
        {
          text: 'Excluir',
          style: 'destructive',
          onPress: () => deleteWeeklyGoal(goalId),
        },
      ]
    );
  };
                ...
                <View style={styles.weekView}>
                  {Object.entries(goal.distribution || {}).map(([day, hours]) => (
                    <View key={day} style={styles.dayColumn}>
                      ...
                      <Text style={styles.dayHours}>{(parseFloat(hours as string) || 0).toFixed(1)}h</Text>
                    </View>
                  ))}
                </View>
              </View>
